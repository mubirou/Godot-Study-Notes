...
```
参考：[小数点以下2桁表示](https://docs.godotengine.org/ja/stable/tutorials/scripting/gdscript/gdscript_format_string.html#padding),[外部フォント](https://note.com/doromaito/n/n60e16bdaa1be)  
