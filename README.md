...
📝注意：[**RigidBody3D.apply_force(Vector3)**](#220612-3") による衝突判定の場合は薄い壁は通過してしまうため「無限平面」である [**WorldBoundaryShape3D**](https://bit.ly/3BFlrQ6) を利用している  
