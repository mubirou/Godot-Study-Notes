...
* **user://xxx.dat** の場合は「C:\Users\◇◇\AppData\Roaming\Godot\app_userdata\△△\〇〇.dat」（Windows）  
* **res://xxx.dat** の場合は「
  [プロジェクトのルート](https://docs.godotengine.org/ja/stable/tutorials/scripting/filesystem.html?highlight=res%3A%2F%2F#resource-path)」に保存  
