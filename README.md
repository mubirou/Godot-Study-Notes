...
* オブジェクトの"大きさ"  
    ...
    注意：〇〇BodyやMeshInstanceのScaleは全て初期値  

* オブジェクトの"位置"や"角度"  
    各 **〇〇Body** の [Transform]-[**Translation**] と [**Rotation**] で設定  
    注意：CollisionShapeやMeshInstanceのTranslationとRotationは全て初期値  
