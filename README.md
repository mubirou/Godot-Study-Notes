...
* 自作テンプレート：[**webxr_template_240623.zip**](https://github.com/mubirou/Godot/blob/main/zip/webxr_template_240623.zip)🔥（[Godot 4.2.2](https://godotengine.org/download/archive/4.2.2-stable/) 対応）  
