...
<a id="220620"></a>
# <b>外部テキストの読み書き</b>
VRコントローラーのＢボタンでデータ（現在の時間）を保存、Ａボタンでデータを読み込むサンプルコード  
