...
1. [Convertio](https://convertio.co/ja/) などで [**OGV（.ogv）**](https://www.theora.org/) に変換（[サポート再生形式](https://docs.godotengine.org/en/latest/tutorials/animation/playing_videos.html?highlight=Video#supported-playback-formats)
