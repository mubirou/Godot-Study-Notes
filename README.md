...
1. 引続き [**default_env.tres**]-[インスペクター]-[Sky]-[PanoramaSky]-[編集]-[**Radiance Size**] を **512** に設定
...
1. [ファイルシステム]-[**default_env.tres**]-[インスペクター]-[Sky]-[PanoramaSky]-[編集]-[**Radiance Size**] を **512** に設定
1. 大元の Spatial を選択し [子ノードを追加]-[**MeshInstance**] を選択
