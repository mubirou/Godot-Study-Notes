...
1. 修正箇所のポイントは次の通り    
  * **_ready** 時の処理  
    * **get_node("SE1")**（[**AudioStreamPlayer3D**](https://docs.godotengine.org/en/latest/classes/class_audiostreamplayer3d.html?highlight=AudioStreamPlayer3D#audiostreamplayer3d) ノードの取得）
