...
**（参考）動く雲**  
  ...
  * 内側（動くパノラマ）をスクリプトで動かす  
    ...
    ```
    （ポイント）[StandardMaterial3D.uv1_offset.x](https://docs.godotengine.org/en/latest/classes/class_basematerial3d.html?highlight=uv1_offset#class-basematerial3d-property-uv1-offset) を変更  
