...
* 公開サイト：[**mubirou.com**](https://mubirou.com/webxr-lab/)（[Quest](https://www.meta.com/jp/quest/quest-3/)でご覧ください）  
* 自作テンプレート：[**WebXR Template Ver.240527**](https://github.com/mubirou/Godot/blob/main/zip/webxr_template_240527.zip) (Godot 4.2.2用)  
