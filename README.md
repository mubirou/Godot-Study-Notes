...
📝 [**StaticBody3D**](#220612-1) → [**Area3D**](#220612-1) の衝突判定ができない（[**Area3D**](#220612-1) → [**StaticBody3D**](#220612-1) は可能＝要検証）  
📝 **_on_area_3d_area_entered()**（＝**Area3D**同士の衝突判定）や**_on_area_3d_body_entered()**（＝**Area3D**同士の衝突判定）[**イベントの接続**](#220703-1) を参照  
